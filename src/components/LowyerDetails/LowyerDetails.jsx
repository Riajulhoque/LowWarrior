...
const LowyerDetails = () => {
  ...
  const singleLowyer = data.find(lowyer => lowyer.id === lowyerId);
  console.log(id,data);
  ...
  return (
    <div>
      ...
      <div className="lowyerInfo w-[70%] p-10 bg-color-red">
        ...
        <h2>License No:{singleLowyer.licenseNumber}</h2>
        <h2>Availability :{singleLowyer.availability}</h2>
        <h2>name :  {singleLowyer.name}</h2>
        <h2> speciality : {singleLowyer.speciality}</h2>
